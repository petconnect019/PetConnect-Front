      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className={`
            bg-gray-100 
            rounded-2xl
            p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6 xl:p-4 2xl:p-8
        ...
        >
          {showPassword ? (
            <AiFillEyeInvisible className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-7 xl:w-7 xl:h-8 2xl:w-8 2xl:h-10 4xl:h-8 4xl:w-8" />
          ) : (
            <AiFillEye className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 xl:w-7 xl:h-7 2xl:w-8 2xl:h-8 4xl:h-8 4xl:w-8" />
          )}
        </button>
      </div>
    </div>
