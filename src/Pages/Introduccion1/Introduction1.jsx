                        ...
                        <div className="text-center space-y-4">
                            ...
                            <div className='flex justify-between gap-4 pt-6'>
                                <button 
                                    ...
                                    className="flex-1 bg-gray-100 text-orange-500 py-3 rounded-full text-base font-medium shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105 active:scale-95"
                                >
                                    Saltar
                                </button>
                                <button 
